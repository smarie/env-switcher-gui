...
export PYQT_SRC_URL=https://sourceforge.net/projects/pyqt/files/PyQt5/PyQt-5.6/PyQt5_gpl-5.6.tar.gz/download

echo "(a) Downloading PyQt sources from $PYQT_SRC_URL in "
pwd
wget -q $PYQT_SRC_URL --no-check-certificate -O pyqt-src.tar.gz

echo "(b) Unzipping PyQt sources in "
pwd
tar -xvf pyqt-src.tar.gz >/dev/null
